...
class HrPayslip(models.Model):
    ...
    def _compute_working_days(self):
        for rec in self:
            ...
            # FIX: Convert dayofweek strings to a set of integers
            # This handles the "Morning/Afternoon" double entry issue
            ...
            # Fix for Holiday search: ensure correct datetime format
            ...
            # Ensure x_holiday_types check is robust
